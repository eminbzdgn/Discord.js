...
module.exports.run = async (client, message, args) => {
    ...
    let salvoembed = new Discord.MessageEmbed().setColor("RANDOM").setFooter(`Eon ♥ 147`).setAuthor(message.member.displayName, message.author.avatarURL({dynamic: true}))
    let salvoerkekembed = new Discord.MessageEmbed().setColor(0x56aaff).setFooter(`Eon ♥ 147`).setAuthor(message.member.displayName, message.author.avatarURL({dynamic: true}))
    let salvokızembed = new Discord.MessageEmbed().setColor(0xff00ff).setFooter(`Eon ♥ 147`).setAuthor(message.member.displayName, message.author.avatarURL({dynamic: true}))
